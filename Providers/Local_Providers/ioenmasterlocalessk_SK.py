...
from faker.providers.address.sk_SK import Provider
...
class Provider:
    ...
    def street_suffix_long(
        self,
    ) -> str:
        ...

    def street_suffix_short(
        self,
    ) -> str:
        ...


from faker.providers.automotive.sk_SK import Provider
...
from faker.providers.color.sk_SK import Provider
...
from faker.providers.company.sk_SK import Provider
...
from faker.providers.currency.sk_SK import Provider
...
from faker.providers.date_time.sk_SK import Provider
...
from faker.providers.internet.sk_SK import Provider
...
from faker.providers.job.sk_SK import Provider
...
from faker.providers.phone_number.sk_SK import Provider
...
from faker.providers.ssn.sk_SK import Provider
