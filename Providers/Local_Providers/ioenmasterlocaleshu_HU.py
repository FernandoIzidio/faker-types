...
class Provider:
    ...
    def street_address_with_county(
        self,
    ) -> str:
        ...
...
from faker.providers.automotive.hu_HU import Provider
...
from faker.providers.color.hu_HU import Provider
...
from faker.providers.company.hu_HU import Provider
...
from faker.providers.date_time.hu_HU import Provider
...
from faker.providers.internet.hu_HU import Provider
...
from faker.providers.job.hu_HU import Provider
...
from faker.providers.person.hu_HU import Provider
...
class Provider:
    ...
    def first_name_female_abbreviated(
        self,
    ) -> str:
        ...
    ...
    def first_name_male_abbreviated(
        self,
    ) -> str:
        ...
...
from faker.providers.phone_number.hu_HU import Provider
...
from faker.providers.ssn.hu_HU import Provider
