...
from faker.providers.address.bn_BD import Provider
...
from faker.providers.automotive.bn_BD import Provider
...
class Provider:
    ...
    def vehicle_category_letter(
        self,
    ) -> str:
        ...

    def vehicle_category_number(
        self,
    ) -> str:
        ...

    def vehicle_serial_number(
        self,
    ) -> str:
        ...
...
from faker.providers.bank.bn_BD import Provider
...
from faker.providers.color.bn_BD import Provider
...
from faker.providers.company.bn_BD import Provider
...
from faker.providers.currency.bn_BD import Provider
...
from faker.providers.date_time.bn_BD import Provider
...
from faker.providers.geo.bn_BD import Provider
...
from faker.providers.internet.bn_BD import Provider
...
from faker.providers.job.bn_BD import Provider
...
from faker.providers.lorem.bn_BD import Provider
...
from faker.providers.person.bn_BD import Provider
...
class Provider:
    ...
    def first_name_female_common(
        self,
    ) -> str:
        ...

    def first_name_female_hinduism(
        self,
    ) -> str:
        ...

    def first_name_female_islamic(
        self,
    ) -> str:
        ...
    ...
    def first_name_male_hinduism(
        self,
    ) -> str:
        ...

    def first_name_male_islamic(
        self,
    ) -> str:
        ...
    ...
    def last_name_female_islamic(
        self,
    ) -> str:
        ...

    def last_name_hinduism(
        self,
    ) -> str:
        ...

    def last_name_islamic(
        self,
    ) -> str:
        ...
...
from faker.providers.phone_number.bn_BD import Provider
...
from faker.providers.ssn.bn_BD import Provider
