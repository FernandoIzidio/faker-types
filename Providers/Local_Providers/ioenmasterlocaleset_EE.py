...
from faker.providers.automotive.et_EE import Provider
...
from faker.providers.person.et_EE import Provider
...
class Provider:
    ...
    def first_name_female_est(
        self,
    ) -> str:
        ...

    def first_name_female_rus(
        self,
    ) -> str:
        ...
    ...
    def first_name_male_est(
        self,
    ) -> str:
        ...

    def first_name_male_rus(
        self,
    ) -> str:
        ...
...
from faker.providers.ssn.et_EE import Provider
