...
from faker.providers.address.es_CO import Provider
...
from faker.providers.automotive.es_CO import Provider
...
from faker.providers.job.es_CO import Provider
...
from faker.providers.phone_number.es_CO import Provider
...
from faker.providers.ssn.es_CO import Provider


class Provider:
    def legal_person_nit(
        self,
    ) -> str:
        ...

    def legal_person_nit_with_check_digit(
        self,
    ) -> str:
        ...

    def natural_person_nit(
        self,
    ) -> str:
        ...

    def natural_person_nit_with_check_digit(
        self,
    ) -> str:
        ...
