...
from faker.providers.address.es_CL import Provider
...
class Provider:
    ...
    def historic_people_street_name(
        self,
    ) -> str:
        ...

    def plant_street_name(
        self,
    ) -> str:
        ...
...
from faker.providers.automotive.es_CL import Provider
...
class Provider:
    ...
    def license_plate_diplomatic(
        self,
    ) -> str:
        ...

    def license_plate_new(
        self,
    ) -> str:
        ...

    def license_plate_old(
        self,
    ) -> str:
        ...

    def license_plate_police(
        self,
    ) -> str:
        ...

    def license_plate_temporary(
        self,
    ) -> str:
        ...
...
from faker.providers.color.es_CL import Provider
...
from faker.providers.company.es_CL import Provider
...
from faker.providers.currency.es_CL import Provider
...
from faker.providers.date_time.es_CL import Provider
...
from faker.providers.internet.es_CL import Provider
...
from faker.providers.job.es_CL import Provider
...
from faker.providers.person.es_CL import Provider
...
from faker.providers.phone_number.es_CL import Provider
...
from faker.providers.ssn.es_CL import Provider
