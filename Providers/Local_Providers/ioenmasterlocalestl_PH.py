...
from faker.providers.address.tl_PH import Provider
...
from faker.providers.automotive.tl_PH import Provider
...
from faker.providers.bank.tl_PH import Provider
...
from faker.providers.company.tl_PH import Provider
...
class Provider:
    ...
    def random_good_service_adjective(
        self,
    ) -> str:
        ...

    def random_good_service_adjective_chain(
        self,
    ) -> str:
        ...

    def random_noun_ish_good_trait(
        self,
    ) -> str:
        ...

    def random_object_of_concern(
        self,
    ) -> str:
        ...


from faker.providers.date_time.tl_PH import Provider
...
from faker.providers.internet.tl_PH import Provider
...
from faker.providers.lorem.tl_PH import Provider
...
from faker.providers.misc.tl_PH import Provider
...
from faker.providers.phone_number.tl_PH import Provider
...
from faker.providers.ssn.tl_PH import Provider
