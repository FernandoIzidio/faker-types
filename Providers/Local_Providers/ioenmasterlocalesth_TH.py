...
from faker.providers.address.th_TH import Provider
...
from faker.providers.automotive.th_TH import Provider
...
from faker.providers.bank.th_TH import Provider
...
from faker.providers.color.th_TH import Provider
...
from faker.providers.company.th_TH import Provider
...
class Provider:
    ...
    def company_limited_prefix(
        self,
    ) -> str:
        ...

    def company_limited_suffix(
        self,
    ) -> str:
        ...
    ...
    def nonprofit_prefix(
        self,
    ) -> str:
        ...


from faker.providers.currency.th_TH import Provider
...
from faker.providers.date_time.th_TH import Provider
...
from faker.providers.internet.th_TH import Provider
...
from faker.providers.job.th_TH import Provider
...
from faker.providers.lorem.th_TH import Provider
...
from faker.providers.person.th_TH import Provider
...
from faker.providers.phone_number.th_TH import Provider
...
from faker.providers.ssn.th_TH import Provider
